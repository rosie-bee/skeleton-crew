...
def actionOneN():
 ...
 if actionInput == "6":
  ...
  if mapArtifact == 1:
   ...
   foundMap = 1
   artifactInPossession = 0
   print("Oh, this is very interesting!  I'll add it right away.")
 ...
 if actionInput == "7":
  ...
  if foundMap == 1:
   print("4. I'd like to learn about the map.")
  ...
  if artifactInput=="3":
   ...
   input()
  if artifactInput=="4":
   print("Ophelia is beaming with pride.")
   print("This is an old map of Watson's Harbor.")
   print("You can see it looks a bit different than it does now.")
   print("That's because their mapping methods were flawed.")
   print("This was likely used by Watson's whaling parties to navigate.")
   print("It even indicates areas of heavy fog, which is very interesting!")
   print("We can assume the fog was even worse back then.")
   print("- - - - -")
   print("What would you like to say?")
   print("1. Oh, thank you for explaining it to me.")
   print("2. What about those other markings?")
   mapResponse=input()
   if mapResponse == "1":
     opheliaLove=opheliaLove+15
     print("'You're welcome, "+name+" !'")
...
def actionThreeN():
 ...
 if actionInput == "4":
  ...
  print("3. Strike out further into the woods")
  if mansionDiscovered == 1:
   print("4. Return to the mansion")
  forestInput=input()
  if forestInput == "1":
  ...
  if forestInput=="2":
   ...
   input()
  if forestInput=="3":
   print("You strike out further into the wilderness.")
   print("The forest is much thicker here.")
   print("It covers the ground, ferns and brush and trees choking out light.")
   print("Up ahead, you see a clearing.")
   print("What would you like to do?")
   print("- - - - -")
   ...
   exploreInput=input()
   if exploreInput == "1":
    print("As you continue forward, it seems as if some of the brush is damaged.")
    print("It looks like someone took a machete to the brush around here.")
    print("Continuing forward, the trees begin to thin out.")
    print("You've never been this far in before.")
    input()
    teamAddFatigue+=10
    print("You eventually come upon a new clearing, this one much larger.")
    print("An overgrown and dilapidated mansion sits in front of you.")
    print("Something about it seems... wrong.")
    teamAddTerror+=30
    mansionDiscovered=1
    print("Proceed into the mansion?")
    print("- - - - -")
    print("1. Yes")
    print("2. No")
    mansionResponse = input()
    if mansionResponse == "1":
     mansionEntrance()
  if forestInput=="4":
    if mansionDiscovered == 1:
        mansionEntrance()
...
def mansionEntrance():
 ...
 global robinQuestEnable
 global robinQuestStage
 print("The dust-filled halls of the mansion sit before you.")
 teamAddTerror+=10
 print("You feel as if you should not be here.")
 print("What would you like to do?")
 print("- - - - -")
 print("1. Look around for valuables")
 print("2. Look around for books")
 print("3. Look around for any journals")
 if robinQuestEnable == 1 & robinQuestStage > 1:
  print("4. Call out for Jonathan")
 mansionAction = input()
 if mansionAction == "1":
  if artifactInPossession == 1:
     print("You have a feeling carrying an artifact is bad luck.")
  ...
  if artifactInPossession == 0:
     if foundMap == 1:
      print("You find nothing of note.")
     if foundMap == 0:
      print("You find a map in one of the studies.")
      print("It is old, but still somewhat sturdy.")
      print("It seems like a map of Watson's Harbor, but with some odd markings.")
      mapArtifact = 1
      artifactInPossession=1
 if mansionAction == "2":
  teamAddTerror+=20
  bookChance = random.randint(1,10)
  if bookChance == 1:
   print("You find a book detailing physical health.")
   print("You can take this knowledge back to your team.")
   teamAddPower += 40
  if bookChance == 2:
   print("You find a book detailing physical endurance.")
   print("You can take this knowledge back to your team.")
   teamAddEndurance += 40
  if bookChance == 3:
   print("You find a book detailing proper rest and recovery.")
   print("You can take this knowledge back to your team.")
   teamAddFatigue -= 40
  if bookChance == 4:
   print("You find a book detailing teamwork in physical labor.")
   print("You can take this knowledge back to your team.")
   teamAddRhythm += 40
  if bookChance == 5:
   print("You find a book detailing building fine muscle precision.")
   print("You can take this knowledge back to your team.")
   teamAddTechnique += 40
  if bookChance == 6:
   print("You find a short but endearing fiction novel.")
   print("This is certainly a good way to pass the time.")
   teamAddMorale += 40
  if bookChance > 6:
   print("You find a book.")
   print("You can hardly make sense of it.")
   print("You feel a crushing dread the deeper you get into the book.")
   print("You can't seem to set it down.")
   teamAddTerror += 40
  input()
...
def actionFourN():
  ...
  if boathouseInput == "7":
   ...
   print(" ~ ~ ~ ~ ~")
   print("1. Jesus!  What are you doing here?")
   print("2. Hey?  Are you doing okay?")
   print("3. I can see you, you know.")
   robinQuestResponse=input()
   if robinQuestResponse == "1":
    print("'I'm sorry, Coach" +name+ ".'")
    print("'I just... I needed to talk to you about something.'")

   if robinQuestResponse == "2":
    print("'Not really, Coach " +name+ ".'")
    print("'Can we talk?'")

   if robinQuestResponse == "3":
    print("'I'm sorry, Coach" +name+ ".'")
    print("'I just... I needed to talk to you about something.'")
   robinQuestDialogueOne()
   robinQuestResponse=input()
   if robinQuestResponse == "1":
    print("'Well, you know I have a brother.. right?'")
    print("'Anyways, I'm a little bit worried about him.'")
    print("'He's been spending a lot of time out of the house and I don't really know where he goes.'")
    print("'When he comes home he looks... sickly.'")
    print("'And he doesn't talk to me anymore.'")
    print("'I understand if you can't, Coach.'")
    input()
    print("'But if you can, let me know if you see him, okay?'")
   if robinQuestResponse == "2":
    print("'I have, but they don't seem to care.'")
    print("'It's really been affecting me during practice...'")
    print("'So I figured I'd talk to you.'")
    input()
    print("'I've been worried about my brother lately'")
    print("'He's been spending a lot of time out of the house and I don't really know where he goes.'")
    print("'When he comes home he looks... sickly.'")
    print("'And he doesn't talk to me anymore.'")
    print("'I understand if you can't, Coach.'")
   ...
   if robinQuestResponse == "3":
    print("I'm sorry.")
    print("'This has been really been affecting me during practice...'")
    print("'So I figured I'd talk to you.'")
    input()
    print("'I've been worried about my brother lately'")
    print("'He's been spending a lot of time out of the house and I don't really know where he goes.'")
    ...
    input()
    print("'But if you can, let me know if you see him, okay?'")
   robinQuestDialogueTwo()
   robinQuestResponse = input()
   if robinQuestResponse == "1":
    print("'Thank you so much!'")
    print("'This really means a lot to me.'")
    print("'His name is Jonathan, if that helps.'")
    robinQuestStage = 1
    input()
   if robinQuestResponse == "2":
    print("'Oh!  He looks a lot like me, only taller.'")
    print("'You'll know him when you see him.'")
    print("'His name is Jonathan, if that helps.'")
   ...
   if robinQuestResponse == "3":
    print("'Oh.'")
    print("'I'm sorry to bother you with this.'")
    robinTerror= robinTerror+150
    print("'Goodnight.'")
    robinQuestEnable=0
...
def robinQuestDialogueOne():
 print("What would you like to say to Robin?")
 print(" ~ ~ ~ ~ ~")
 print("1. Yeah, of course, what's up?")
 print("2. Hm.  Haven't you thought of talking to your parents, or something?")
 print("3. ")

def robinQuestDialogueTwo():
 print("What would you like to say to Robin?")
 print(" ~ ~ ~ ~ ~")
 print("1. I will.  Thank you for telling me.")
 print("2. What does he look like?")
 print("3. No, I can't do that for you.")
...
def actionSixN():
 ...
 teamAddTerror-=5
 nightTime-=60
 print("You return home, lighting your desk lamp and glancing over to your bookshelf.")
 print("What would you like to learn more about?")
 print("1. Boat roles")
 print("2. Proper rowing technique")
 print("3. Life in Watson's Harbor")
 studySelect = input()
 if studySelect == "1":
  print("A boat is only as good as its rowers, and a rower is only as good as their role.")
  print("Putting rowers in positions where they are more effective will drastically increase boat speed.")
  print("The first two seats of the boat, 7 and Stroke, are the most important for setting the rhythm of the boat.")
  print("Athletes who excel at setting a pace and maintaining it should row in these seats.")
  print("Seats 5 and 6 provide the main power to the craft.  The strongest of your team should row in these seats.")
  print("If seats 3 and 4 tire too early, it could spell disaster for the boat speed.  Make sure any rowers in these seats do not tire easily.")
  print("Bow and 2 seat are most responsible for the set of the boat, and thus should exhibit the best technique.")
  input()
 if studySelect == "2":
  print("You study proper rowing technique.")
  print("You learn enough to take back to your team.")
  input()
  teamAddTechnique+=15
 if studySelect == "3":
  randomAdvice = random.randint(1,5)
  if randomAdvice == 1:
   print("Watson's Harbor is a lovely place - but the fog can wreak havoc on machinery, buildings, and people alike.")
   print("Be careful not to stay too long outside in the fog, and never do anything to anger it.")
   input()
  if randomAdvice == 2:
   print("Watson's Harbor is home to lovely people - befriend whomever you feel inclined to.")
   print("Who knows?  It may prove vital.")
   input()
  if randomAdvice == 3:
   print("A balanced rowing team is an effective rowing team.  Leaning too hard into one area of improvement will leave the others lacking.")
   print("After all, one must be prepared for anything.")
   input()
  if randomAdvice == 4:
   print("Beating Newhaven Crew is going to be a challenge, and some... unorthodox methods may have to be taken to give you the edge.")
   print("Be careful not to lose yourself in the process, though.")
   input()
  if randomAdvice == 5:
   print("Watson's Harbor is home to lovely fishing docks.  From morning till sunset, you can buy the catch of the day, as fresh as can be.")
   print("However, leave the docks when night falls, and the fog rolls in.")
   input()
...
def saveGame():
 ...
 lst = [day, week, mansionDiscovered, opheliaEvent, compStarter, compIncrement, winCounter, robinQuestComplete, robinQuestEnable, robinQuestStage, featherArtifact, foundFeather, boatDamage, practiceTimeModifier, arrowheadsInPossession,
 coinArtifact, 
 mapArtifact, 
 foundCoin,
 foundMap,
...
def loadGame():
 ...
 save=open("SC_Save.txt","r")
 day = int(save.readline())
 week = int(save.readline())
 mansionDiscovered = int(save.readline())
 opheliaEvent = int(save.readline())
 compStarter = int(save.readline())
 compIncrement = int(save.readline())
 winCounter = int(save.readline())
 robinQuestComplete = int(save.readline())
 robinQuestEnable = int(save.readline())
 robinQuestStage = int(save.readline())
 featherArtifact = int(save.readline())
 foundFeather = int(save.readline())
 boatDamage = int(save.readline())
 practiceTimeModifier = int(save.readline())
 arrowheadsInPossession = int(save.readline())
 coinArtifact = int(save.readline())
 mapArtifact = int(save.readline())
 foundCoin = int(save.readline())
 foundMap = int(save.readline())
 foundHarpoon = int(save.readline())
 harpoonArtifact = int(save.readline())
 fishermenRep = int(save.readline())
 beingEncountered = int(save.readline())
 meteorLanded = int(save.readline())
 compCounter = int(save.readline()) 
 fishInPossession= int(save.readline())
 artifactInPossession = int(save.readline())
 opheliaLove = int(save.readline())
 opheliaAuthority = int(save.readline())
 progressMod = float(save.readline())
 nightTerror = int(save.readline())
 samEndurance = float(save.readline())
 samPower = float(save.readline())
 samFatigue = float(save.readline())
 samMorale = float(save.readline())
 samRhythm = float(save.readline())
 samTechnique = float(save.readline())
 samTerror = float(save.readline())
 ollieEndurance = float(save.readline())
 olliePower = float(save.readline())
 ollieFatigue = float(save.readline())
 ollieMorale = float(save.readline())
 ollieRhythm = float(save.readline())
 ollieTechnique = float(save.readline())
 ollieTerror = float(save.readline())
 noelEndurance= float(save.readline())
 noelPower= float(save.readline())
 noelFatigue= float(save.readline())
 noelMorale= float(save.readline())
 noelRhythm= float(save.readline())
 noelTechnique= float(save.readline())
 noelTerror= float(save.readline())
 robinEndurance= float(save.readline())
 robinPower= float(save.readline())
 robinFatigue= float(save.readline())
 robinMorale= float(save.readline())
 robinRhythm= float(save.readline())
 robfloatechnique= float(save.readline())
 robfloaterror= float(save.readline())
 krisEndurance= float(save.readline())
 krisPower= float(save.readline())
 krisFatigue= float(save.readline())
 krisMorale= float(save.readline())
 krisRhythm= float(save.readline())
 krisTechnique= float(save.readline())
 krisTerror= float(save.readline())
 milanEndurance= float(save.readline())
 milanPower= float(save.readline())
 milanFatigue= float(save.readline())
 milanMorale= float(save.readline())
 milanRhythm= float(save.readline())
 milanTechnique= float(save.readline())
 milanTerror= float(save.readline())
 angelEndurance= float(save.readline())
 angelPower= float(save.readline())
 angelFatigue= float(save.readline())
 angelMorale= float(save.readline())
 angelRhythm= float(save.readline())
 angelTechnique= float(save.readline())
 angelTerror= float(save.readline())
 santanaEndurance= float(save.readline())
 santanaPower= float(save.readline())
 santanaFatigue= float(save.readline())
 santanaMorale= float(save.readline())
 santanaRhythm= float(save.readline())
 santanaTechnique= float(save.readline())
 santanaTerror= float(save.readline())
 hasAchievementTie= float(save.readline())
 name = save.readline()
 teamName = save.readline()
...
if day==0:
 while True:
  ...
  print(Style.RESET_ALL)
  print("Are you loading a save? (y/n)")
  saveResponse=input()
  if saveResponse == "y":
   loadGame()
   print("Save Loaded!")
